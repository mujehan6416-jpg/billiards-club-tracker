        ...
        <div className="card col-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <input type="number" inputMode="numeric" min={0} value={form.amount} placeholder="0"
              onChange={(e) => set('amount')(e.target.value)} style={{ fontSize: 18, padding: '12px 14px' }} />
          </div>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <input type="number" inputMode="numeric" min={0} value={form.clubShare} placeholder={form.amount || '0'} onChange={(e) => set('clubShare')(e.target.value)} />
            </div>
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
              <span className="muted" style={{ fontSize: 12 }}>개인 찬조액</span>
              <input type="number" inputMode="numeric" min={0} value={form.personalDonation} placeholder="0" onChange={(e) => set('personalDonation')(e.target.value)} />
            </div>
          </div>
